	...
	public int columnToPick()
	{
		...
		while (validColumnPicked)
		{
			...
			if (Input.hasNextInt())
			{
				...
				else System.out.print("Invalid column number picked. Enter an column number between 0-6.");	
			}
			else System.out.print("Invalid Entry. Enter an integer value between 0-6.");
		}
		return column;
	}
